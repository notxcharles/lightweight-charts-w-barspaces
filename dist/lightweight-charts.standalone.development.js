    ...
    ***************************************************************************** */
    ...
    var PriceAxisViewRenderer = /** @class */ (function () {
        ...
        PriceAxisViewRenderer.prototype._internal_draw = function (ctx, rendererOptions, textWidthCache, width, align, pixelRatio) {
            ...
            var tickSize = this._private__data._internal_tickVisible ? rendererOptions._internal_tickLength : 0;
            ...
            var xTick;
            var xText;
            ctx.fillStyle = resetTransparency(this._private__commonData._internal_background);
            ctx.lineWidth = 1;
            ctx.lineCap = 'butt';
            if (text) {
                if (alignRight) {
    ...
    var CrosshairPriceAxisView = /** @class */ (function (_super) {
        ...
        CrosshairPriceAxisView.prototype._internal__updateRendererData = function (axisRendererData, paneRendererData, commonRendererData) {
            ...
            commonRendererData._internal_background = options.labelBackgroundColor;
            commonRendererData._internal_color = generateTextColor(options.labelBackgroundColor);
    ...
    var Crosshair = /** @class */ (function (_super) {
        ...
        function Crosshair(model, options) {
            ...
            var valueTimeProvider = function (rawIndexProvider, rawCoordinateProvider) {
                return function () {
                    return {
                        _internal_time: _this._private__model._internal_timeScale()._internal_indexToUserTime(rawIndexProvider()),
        ...
        Crosshair.prototype._internal_index = function () {
    ...
    var PriceRangeImpl = /** @class */ (function () {
        ...
        PriceRangeImpl.prototype._internal_setMinValue = function (v) {
            this._private__minValue = v;
        };
        PriceRangeImpl.prototype._internal_maxValue = function () {
            return this._private__maxValue;
        };
        PriceRangeImpl.prototype._internal_setMaxValue = function (v) {
        ...
        PriceRangeImpl.prototype._internal_containsStrictly = function (priceRange) {
            return priceRange._internal_minValue() > this._private__minValue &&
                priceRange._internal_maxValue() < this._private__maxValue;
        };
    ...
    var PriceTickMarkBuilder = /** @class */ (function () {
        ...
        PriceTickMarkBuilder.prototype._internal_setBase = function (base) {
            if (base < 0) {
    ...
    var TimeScaleVisibleRange = /** @class */ (function () {
        ...
        TimeScaleVisibleRange.prototype._internal_isValid = function () {
            return this._private__logicalRange !== null;
        };
    ...
    var SeriesPaneViewBase = /** @class */ (function () {
        ...
        SeriesPaneViewBase.prototype._internal__updatePoints = function () {
            ...
            if (this._internal__series._internal_data()._internal_bars()._internal_size() === 0) {
                return;
            }
    ...
    var BarsPaneViewBase = /** @class */ (function (_super) {
        ...
        BarsPaneViewBase.prototype._internal__fillRawPoints = function () {
            ...
            var colorer = this._internal__series._internal_barColorer();
            this._internal__series._internal_bars()._internal_each(function (index, bar) {
                var item = _this._internal__createRawItem(index, bar, colorer);
                newItems.push(item);
                return false;
            });
            this._internal__items = newItems;
    ...
    var PanePriceAxisView = /** @class */ (function () {
        ...
        PanePriceAxisView.prototype._internal_update = function () {
        ...
        PanePriceAxisView.prototype._internal_renderer = function (height, width) {
            ...
            var priceScale = this._private__dataSource._internal_priceScale();
            if (priceScale === null) {
                return null;
            }
    ...
    var SeriesPriceLinePaneView = /** @class */ (function (_super) {
        ...
        SeriesPriceLinePaneView.prototype._internal__updateImpl = function (height, width) {
            ...
            var lastValueData = this._internal__series._internal_lastValueData(undefined, seriesOptions.priceLineSource === 0 /* LastBar */);
    ...
    var Magnet = /** @class */ (function () {
        ...
        Magnet.prototype._internal_align = function (price, index, pane) {
            ...
            var candidates = serieses.reduce(function (acc, series) {
                ...
                return acc.concat(prices.map(function (barPrice) { return ps._internal_priceToCoordinate(barPrice, firstPrice._internal_value); }));
            }, []);
    ...
    var Pane = /** @class */ (function () {
        ...
        Pane.prototype._internal_setPriceAutoScale = function (priceScale, autoScale) {
            priceScale._internal_setMode({
                _internal_autoScale: autoScale,
            });
            if (this._private__timeScale._internal_isEmpty()) {
                priceScale._internal_setPriceRange(null);
                return;
            }
            this._internal_recalculatePriceScale(priceScale);
        };
        Pane.prototype._internal_updateAllViews = function () {
            this._private__dataSources.forEach(function (source) {
        ...
        Pane.prototype._internal_isEmpty = function () {
            return this._private__dataSources.length === 0;
        };
        ...
        Pane.prototype._private__createPriceScale = function (id, options) {
            var actualOptions = __assign({ _internal_visible: true, _internal_autoScale: true }, clone(options));
            ...
            data._internal_lines = [
                {
                    ...
                    _internal_font: makeFont(options.fontSize),
    ...
    var PriceAxisWidget = /** @class */ (function () {
        ...
        PriceAxisWidget.prototype._internal_destroy = function () {
            ...
            if (this._private__priceScale !== null) {
                ...
                this._private__priceScale._internal_optionsChanged()._internal_unsubscribeAll(this);
            }
            this._private__priceScale = null;
        ...
        PriceAxisWidget.prototype._internal_optimalWidth = function () {
            if (!this._internal_isVisible() || this._private__priceScale === null) {
                return 0;
            }
        ...
        PriceAxisWidget.prototype._internal_isVisible = function () {
            return this._private__isVisible;
        };
        PriceAxisWidget.prototype._internal_setVisible = function (visible) {
        ...
        PriceAxisWidget.prototype._internal_setAutoScale = function (on) {
            var pane = this._private__pane._internal_state();
            var model = this._private__pane._internal_chart()._internal_model();
            model._internal_setPriceAutoScale(pane, ensureNotNull(this._internal_priceScale()), on);
        };
        ...
        PriceAxisWidget.prototype._internal_isLeft = function () {
        ...
        PriceAxisWidget.prototype._private__drawTickMarks = function (ctx, pixelRatio) {
            ...
            ctx.fillStyle = this._internal_lineColor();
            var rendererOptions = this._internal_rendererOptions();
            var drawTicks = this._private__priceScale._internal_options().borderVisible;
        ...
        PriceAxisWidget.prototype._private__drawCrosshairLabel = function (ctx, pixelRatio) {
            ...
            views.forEach(function (arr) {
                arr.forEach(function (view) {
                    ctx.save();
                    view._internal_renderer()._internal_draw(ctx, ro, _this._private__widthCache, size._internal_w, align, pixelRatio);
                    ctx.restore();
                });
            });
            ctx.restore();
    ...
    var PriceAxisStub = /** @class */ (function () {
        ...
        PriceAxisStub.prototype._internal_update = function () {
            this._private__invalidated = true;
        };
        ...
        PriceAxisStub.prototype._internal_isLeft = function () {
            return this._private__isLeft;
        };
    ...
    function markWithGreaterSpan(a, b) {
        return a._internal_span > b._internal_span ? a : b;
    }
    var TimeAxisWidget = /** @class */ (function () {
        ...
        TimeAxisWidget.prototype._internal_width = function () {
            return this._private__size._internal_w;
        };
        TimeAxisWidget.prototype._internal_height = function () {
            return this._private__size._internal_h;
        };
        ...
        TimeAxisWidget.prototype._private__drawTickMarks = function (ctx, pixelRatio) {
            ...
            ?YEAR -> 70
            */
            var maxSpan = tickMarks.reduce(markWithGreaterSpan, tickMarks[0])._internal_span;
            ...
            drawScaled(ctx, pixelRatio, function () {
                ...
                for (var _i = 0, tickMarks_1 = tickMarks; _i < tickMarks_1.length; _i++) {
                    var tickMark = tickMarks_1[_i];
                    if (tickMark._internal_span < maxSpan) {
    ...
    var SeriesApi = /** @class */ (function () {
        ...
        SeriesApi.prototype.barsInLogicalRange = function (range) {
            ...
            var bars = this._internal__series._internal_data()._internal_bars();
            ...
            if (dataFirstBarInRange !== null && dataLastBarInRange !== null) {
                result.from = dataFirstBarInRange._internal_time.businessDay || dataFirstBarInRange._internal_time.timestamp;
                result.to = dataLastBarInRange._internal_time.businessDay || dataLastBarInRange._internal_time.timestamp;
            }
            return result;
        };
        ...
        SeriesApi.prototype.priceScale = function () {
            return this._private__priceScaleApiProvider._internal_priceScale(this._internal__series._internal_priceScale()._internal_id());
        };
    ...
    var PriceScaleApi = /** @class */ (function () {
        ...
        PriceScaleApi.prototype._internal_id = function () {
            return this._private__priceScale()._internal_id();
        };
