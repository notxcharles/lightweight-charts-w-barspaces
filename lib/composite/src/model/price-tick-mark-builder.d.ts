...
export declare type CoordinateToLogicalConverter = (x: number, firstValue: number) => number;
export declare type LogicalToCoordinateConverter = (x: number, firstValue: number, keepItFloat: boolean) => number;
